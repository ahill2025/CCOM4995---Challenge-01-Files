...
Learning a program with assistance is not the same as sitting down and experimenting with the program yourself.  I learned how to approach designing a figure after going through some small hurdles, these mainly coming from creating the roof sections.  
